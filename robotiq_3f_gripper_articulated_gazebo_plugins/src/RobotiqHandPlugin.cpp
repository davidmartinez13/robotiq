...
*/ 
// modifications are from: https://github.com/matthias-mayr/robotiq/commit/29594b58261ef93f3d680e40229cb1af6403a532#diff-3041afad76c2903f06e4163406c9b6d9a8aab93adf46981ba479bb5fd2cf3e7e
                             ...
                             sdf::ElementPtr _sdf)
{
  ...
  this->pubJointStates = this->rosNode->advertise<sensor_msgs::JointState>(
    this->prefix + std::string("robotiq_hand/joint_states"), 10);
